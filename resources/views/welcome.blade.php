        ...
        <div class="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-16">
            <div class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 sm:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
                <a href="#" class="flex items-center lg:justify-center">
                    <img src="/images/laravel.png" alt="hero image" />
                </a>
                <a href="#" class="flex items-center lg:justify-center">
                    <img class="w-28" src="/images/tailwind.png" alt="hero image" />
                </a>

                <a href="#" class="flex items-center lg:justify-center">
                    <img class="w-28" src="/images/vite.svg" alt="hero image" />
                </a>
                <a href="#" class="flex items-center lg:justify-center">
                    <img class="w-28" src="/images/mysql.png" alt="hero image" />
                </a>
            </div>
        </div>
    </section>
